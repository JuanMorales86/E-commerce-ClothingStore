...
if(!clerkey){//comprobar si esta la apikey
    ...
    <RouterLink>
      {/* <AppContexProvider> */}
        <ThemeProvider theme={CustomTheme}>
          <ClerkProvider appearance={{dark, signIn: { baseTheme: neobrutalism}}} publishableKey={clerkey}>
          ...
          <Routes>
            ...
            <Route path={'/contacto'} element={<Contacto setShowFixedImage={handleShowFixedImage} setShowComponent={setShowComponent}/>}  />
            <Route path={'/admin'} element={<ProtectedBackOffice/>} />
            <Route path={'/ordenes'} element={<ProtectedOrderList setShowFixedImage={handleShowFixedImage}/>} />
